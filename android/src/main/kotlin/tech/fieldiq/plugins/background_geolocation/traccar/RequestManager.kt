...
object RequestManager {
    ...
    fun sendRequest(request: String?, headers: String?): Boolean {
    ...
    fun sendRequestAsync(request: String, headers: String?, handler: RequestHandler) {
        RequestAsyncTask(handler).execute(request, headers)
    }
